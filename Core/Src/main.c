...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LD2_Pin|RADIO_NSS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, RADIO_DIO1_Pin|RADIO_DIO2_Pin|RADIO_DIO3_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LD2_Pin RADIO_NSS_Pin */
  GPIO_InitStruct.Pin = LD2_Pin|RADIO_NSS_Pin;
